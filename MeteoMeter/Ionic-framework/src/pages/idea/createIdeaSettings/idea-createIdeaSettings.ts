...
/**
 * class: IdeaCreateIdeaSettings.
 * createIdeaSettings.
 * This is the component of that layout.
 * This component is generated from Concerns domain.
 */
@IonicPage({
  name: 'idea-createIdeaSettings',
  segment: 'idea/createIdeaSettings'
})
@Component({
  selector: 'idea-createIdeaSettings',
  templateUrl: 'idea-createIdeaSettings.html'
})
export class IdeaCreateIdeaSettings {
  constructor(
