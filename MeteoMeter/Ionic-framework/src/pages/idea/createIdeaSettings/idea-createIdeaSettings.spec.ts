...
import { IdeaCreateIdeaSettings } from "./idea-createIdeaSettings";
describe('IdeaCreateIdeaSettings Component', () => {
  let fixture: ComponentFixture<IdeaCreateIdeaSettings>;
  let component: IdeaCreateIdeaSettings;
  let spy: jasmine.Spy;
  ...
  beforeEach(async() => {
    fixture = TestBed.createComponent(IdeaCreateIdeaSettings);
  ...
  it('IdeaCreateIdeaSettings Component: should be created', fakeAsync(() => {
    expect(component instanceof IdeaCreateIdeaSettings).toBeTruthy();
  }));

  it('IdeaCreateIdeaSettings Component: should navigate to language page', fakeAsync(() => {
  ...
  it('IdeaCreateIdeaSettings Component - onToPreview: should navigate to idea-preview page', fakeAsync(() => {
