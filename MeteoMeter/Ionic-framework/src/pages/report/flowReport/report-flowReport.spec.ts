...
import { ReportFlowReport } from "./report-flowReport";
describe('ReportFlowReport Component', () => {
  let fixture: ComponentFixture<ReportFlowReport>;
  let component: ReportFlowReport;
  let spy: jasmine.Spy;
  ...
  beforeEach(async() => {
    fixture = TestBed.createComponent(ReportFlowReport);
  ...
  it('ReportFlowReport Component: should be created', fakeAsync(() => {
    expect(component instanceof ReportFlowReport).toBeTruthy();
  }));

  it('ReportFlowReport Component: should navigate to language page', fakeAsync(() => {
  ...
  it('ReportFlowReport Component - onDisplayResult: should do nothing', fakeAsync(() => {
    spy = spyOn(component, 'onDisplayResult').and.callThrough();
