...
@IonicPage({
  ...
  segment: 'posts/postDetails'
})
@Component({
  selector: 'posts-postDetails',
  templateUrl: 'posts-postDetails.html'
})
export class PostsPostDetails {
  constructor(
