...
describe('NotificationsMain Component', () => {
  let fixture: ComponentFixture<NotificationsMain>;
  let component: NotificationsMain;
  let spy: jasmine.Spy;
  ...
  beforeEach(async() => {
    fixture = TestBed.createComponent(NotificationsMain);
  ...
  it('NotificationsMain Component: should be created', fakeAsync(() => {
    expect(component instanceof NotificationsMain).toBeTruthy();
  }));

  it('NotificationsMain Component: should navigate to language page', fakeAsync(() => {
  ...
  it('NotificationsMain Component - onShow: should do nothing', fakeAsync(() => {
    spy = spyOn(component, 'onShow').and.callThrough();
    component.onShow();
    flushMicrotasks();
    expect(spy).toHaveBeenCalled();
