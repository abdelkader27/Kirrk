...
describe('SettingsApplicationSettings Component', () => {
  let fixture: ComponentFixture<SettingsApplicationSettings>;
  let component: SettingsApplicationSettings;
  let spy: jasmine.Spy;
  ...
  beforeEach(async() => {
    fixture = TestBed.createComponent(SettingsApplicationSettings);
  ...
  it('SettingsApplicationSettings Component: should be created', fakeAsync(() => {
    expect(component instanceof SettingsApplicationSettings).toBeTruthy();
  }));

  it('SettingsApplicationSettings Component: should navigate to language page', fakeAsync(() => {
  ...
  it('SettingsApplicationSettings Component - onChange: should do nothing', fakeAsync(() => {
