...
describe('TabsMain Component', () => {
  ...
  it('TabsMain Component - onCountUnreadNotifications: should do nothing', fakeAsync(() => {
    spy = spyOn(component, 'onCountUnreadNotifications').and.callThrough();
    component.onCountUnreadNotifications();
    flushMicrotasks();
    expect(spy).toHaveBeenCalled();
